<template>
    <div class="flex flex-col mx-auto items-center text-primary justify-center w-1/2 my-10 relative p-16 bg-fade rounded-2xl backdrop-blur backdrop-opacity-1 border border-fade shadow   ">
